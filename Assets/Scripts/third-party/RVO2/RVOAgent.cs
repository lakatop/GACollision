...
namespace RVO
{
     ...
     */
    internal class RVOAgent
    {
        internal IList<KeyValuePair<float, RVOAgent>> agentNeighbors_ = new List<KeyValuePair<float, RVOAgent>>();
         ...
         */
        internal void insertAgentNeighbor(RVOAgent agent, ref float rangeSq)
        {
            if (this != agent)
            {
